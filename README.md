...
This frontend expects an API that provides authentication, products, cart, orders, profile update, and payment-related endpoints.

The app uses a bearer token stored in `localStorage` and attached through an HTTP interceptor.
